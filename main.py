...
from bokeh.models import Div, ColumnDataSource, CustomJS, FileInput, Range1d
...
p = figure(plot_height=400, plot_width=800, tools="xpan,pan,reset,box_zoom,save", toolbar_location="above",
...
p_select = figure(title="Drag the middle and edges of the selection box to change the range above",
                plot_height=400, plot_width=800, tools="xpan,pan,reset,box_zoom,save",y_range=p.y_range,
